...
- [ ] Task 1: Create `ConfirmDialog` component + styled file + barrel export
- [ ] Task 2: Update `Timer.tsx` — render `<ConfirmDialog>` and remove inline confirm row
- [ ] Task 3: Clean up `Timer.styled.tsx` — remove `ConfirmWrapper`, `ConfirmPrompt`, `ConfirmButton`, `CancelButton`

### Phase 2: Docs

- [ ] Task 4: Update docs — components.md, architecture.md, getting-started.md, README.md
